...
import ItemCardWithCounter from './item-cart-with-counter'
...
export function TotalProducts () {
  ...
  return (
    <div className="flex h-[562px] w-full max-w-[827px] grow flex-col gap-4 overflow-y-scroll bg-slate-200 p-3 py-8 md:p-11">
